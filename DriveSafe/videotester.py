...
cap = cv2.VideoCapture(1) # displays camera feed
...
while True:
    ...
    for (x, y, w, h) in faces_detected:
        cv2.rectangle(test_img, (x, y), (x + w, y + h), (255, 0, 0), thickness=7) # Setting rectangle
    ...
    cv2.imshow('Emotion detection software', resized_img) # Displays window
